    ...
    const columns: ColumnsType<DataType> = [
        ...
        },
        {
            ...
            render: id => {
                return (
                    <Space>
                        <Button type='link' onClick={props.onEdit.bind(null, id)}>{t('edit')}</Button>
                        <Popconfirm
                            title={t('deleteTags')}
...
interface TagEditModalProps extends Omit<ModalProps, 'open' | 'onOk' | 'onCancel'> {
    open: boolean;
    ...
    return (
        ...
        >
            <Form
                ...
                style={{ maxWidth: 600 }}
            >
                <Form.Item name='name' label={t('name')} rules={[{ required: true }, { max: 10 }]}>
                    <Input
                        count={{
                            show: true,
                            max: 10,
